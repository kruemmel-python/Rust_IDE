# widgets.py
from PyQt5.QtWidgets import QAction, QFileDialog, QInputDialog, QMessageBox, QDialog, QVBoxLayout, QListWidget, QPushButton
...
def create_menu_bar(parent):
    ...
    push_action.triggered.connect(lambda: git_integration.check_and_push_to_github())
